...
<!-- 🎵 Replace VIDEO_ID with YouTube ID of "Ramo Re" -->
<iframe width="0" height="0"
src="https://youtu.be/9n7tWwa77mY?si=KmecF-A12niKmFdF"
frameborder="0"
allow="autoplay">
</iframe>
...
noBtn.addEventListener("click", function () {
    ...
    // Show prompts
    if (noClickCount === 2) {
        promptText.innerText = "Please 🥺";
    }

    if (noClickCount === 5) {
        promptText.innerText = "Are you sure? 😢";
    }
